...
#define HA_ESP_HUMIDITY_ENDPOINT 17     /* esp humidity sensor device endpoint, used for humidity measurement */
...
#define CARBON_DIOXIDE_MIN_VALUE (400)
#define CARBON_DIOXIDE_MAX_VALUE (10000)
