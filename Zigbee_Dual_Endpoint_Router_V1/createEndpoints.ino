...
static void createZigbeeCo2SensorDevice(esp_zb_ep_list_t *endpointList) {
  ...
  sensorConfig.carbon_dioxide_meas_cfg.min_measured_value = ESP_CARBON_DIOXIDE_MIN_VALUE / 1000000.0;  // PPM
  sensorConfig.carbon_dioxide_meas_cfg.max_measured_value = ESP_CARBON_DIOXIDE_MAX_VALUE / 1000000.0;  // PPM
