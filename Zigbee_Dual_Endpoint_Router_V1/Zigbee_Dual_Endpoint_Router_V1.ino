...
static void esp_zb_task(void *pvParameters) {
  ...
  temp_reporting_info.u.send_info.delta.u16 = 10;
  ...
  co2_reporting_info.u.send_info.delta.u16 = 10;
...
static void esp_app_temp_sensor_handler(void *pvParameters) {
  while (1) {  // loop forever in task
    ...
    log_i("Updating sensor value: %d°C and %fPPM", temp_measured_value, co2_measured_value);
...
void setup() {
  ...
  xTaskCreate(temp_humid_sensor_handler, "temp_sensor_read", 4096, NULL, 10, NULL);
